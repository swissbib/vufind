...
class ESSubject extends ElasticSearch
{
    ...
    /**
     * Storage for the relative frequency.
     *
     * @var float
     */
    private $_relativeFrequency = 0.0;

    /**
     * The frequency of this subject relative to the subjects in a defined set of
     * subjects. This property is extended data and not retrieved directly over
     * Elastic Search. It must be computed and set by a controller.
     *
     * @return float
     */
    public function getRelativeFrequency(): float
    {
        return $this->_relativeFrequency;
    }

    /**
     * Setter for the relative frequency.
     *
     * @param float $value The new value for the relative frequency.
     *
     * @return void|null
     */
    public function setRelativeFrequency(float $value)
    {
        $this->_relativeFrequency = $value;
    }

    /**
     * Storage for the absolute frequency.
     *
     * @var float
     */
    private $_absoluteFrequency = 0.0;

    /**
     * The absolute frequency of this subject which is calculated out of a set of
     * subjects which may contain the same subject multiple times.
     * This property is extended and not retrieved directly over Elastic Search.
     * It must be computed and set by a controller.
     *
     * @return float
     */
    public function getAbsoluteFrequency(): float
    {
        return $this->_absoluteFrequency;
    }

    /**
     * Setter for the absolute frequency.
     *
     * @param float $value The new value for the absolute frequency.
     *
     * @return void|null
     */
    public function setAbsoluteFrequency(float $value)
    {
        $this->_absoluteFrequency= $value;
    }
}
