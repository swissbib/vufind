 ...
 */
namespace SwissbibRdfDataApi\View\Helper;

/**
 * Class RdfApiSubject
 *
 * @category VuFind
 * @package  SwissbibRdfDataApi\View\Helper
 * @author   Christoph Boehm <cbo@outermedia.de>
 * @author   Guenter Hipler <guenter.hipler@unibas.ch.ch>
 * @license  http://opensource.org/licenses/gpl-2.0.php GNU General Public License
 * @link     http://www.vufind.org  Main Page
 */
class RdfApiSubject extends AbstractHelper
{
    /**
     * The subject
     *
     ...
     */
    public function getSubject(): \SwissbibRdfDataApi\VuFind\RecordDriver\APISubject
    {
     ...
     * Sets the  Subject
     *
     * @param \SwissbibRdfDataApi\VuFind\RecordDriver\APISubject|null $_subject The
     *                                                                    subject
     *
     * @return void
     */
    public function setSubject(
        \SwissbibRdfDataApi\VuFind\RecordDriver\APISubject $_subject = null
    ) {
