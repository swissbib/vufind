 ...
 * @link     http://www.vufind.org  Main Page
 */
class RdfApiSubjectCollection extends AbstractHelper
{
    /**
     * Array of subjects
     *
     ...
     *
     * @return \SwissbibRdfDataApi\View\Helper\RdfApiSubject
     */
    protected function getSubjectHelper(): RdfApiSubject
    {
        $this->_subjectHelper = $this->_subjectHelper ?? new RdfApiSubject();
