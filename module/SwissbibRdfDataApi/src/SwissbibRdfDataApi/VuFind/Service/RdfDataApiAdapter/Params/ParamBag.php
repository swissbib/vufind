 ...
 * this type is more or less a copy of the VuFind ParamBag Type
 * unfortunately by now, most types of the VuFind WebApp are part of ZF modules
 * which makes it impossible to use them outside by means of components
