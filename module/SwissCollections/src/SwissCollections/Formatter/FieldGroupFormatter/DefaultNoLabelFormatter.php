<?php
/**
 * SwissCollections: DefaultNoLabelFormatter.php
 *
 * PHP version 7
 *
 ...
 */
class DefaultNoLabelFormatter extends FieldGroupFormatter
{
    public static $NAME = "default-no-label";
    ...
    public function render(&$fieldDataList, &$context): void
    {
        echo $context->phpRenderer->render(
            '/RecordDriver/SolrMarc/FieldGroupFormatter/DefaultNoLabel',
            [
