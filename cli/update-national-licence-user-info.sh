...
then
    echo "You need to specify the LOCAL_DIR, i.e the vufind config to use : for example : bash -c 'export LOCAL_DIR=/usr/local/vufind/httpd/local/classic/XXXXXXX; ./cli/update-national-licence-user-info.sh"
else
